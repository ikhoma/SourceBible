# SourceBible — About page

> CTA note: **“Support SourceBible”** renders as a large **Liquid Glass** primary
> button — iOS 26 `.buttonStyle(.glassProminent)` with blue tint; iOS 18 fallback
> `.borderedProminent`. Pushes the in-app donation screen (StoreKit 2 / DonationService),
> not an inline text link.
>
> Implemented in-app: `SourceBible/Views/Menu/AboutView.swift` (Menu → About). This
> file is the copy source of truth; keep the two in sync.
...
**[ Support SourceBible ]**  ← large blue button
...
- John Owen, An Exposition of the Epistle to the Hebrews — Public Domain
...
**[ Підтримати SourceBible ]**  ← велика синя кнопка
