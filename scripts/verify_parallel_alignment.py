...
# Заміряно на робочій базі 2026-08-16 (155 621 рядок verse_org).
...
BASELINE: dict[tuple[str, str], tuple[int, int]] = {
    ("KJV", "ASV"):   (3, 17),   ("KJV", "NASB"):  (3, 0),    ("KJV", "RST"):  (2698, 9),  ("KJV", "UBIO"): (3337, 33),
    ("ASV", "KJV"):   (3, 0),    ("ASV", "NASB"):  (3, 0),    ("ASV", "RST"):  (2698, 7),  ("ASV", "UBIO"): (3337, 33),
    ("NASB", "KJV"):  (3, 0),    ("NASB", "ASV"):  (3, 17),   ("NASB", "RST"): (2697, 9),  ("NASB", "UBIO"): (3336, 33),
    ("RST", "KJV"):   (2699, 68), ("RST", "ASV"):  (2699, 83), ("RST", "NASB"): (2698, 68), ("RST", "UBIO"): (893, 31),
    ("UBIO", "KJV"):  (3337, 72), ("UBIO", "ASV"): (3337, 89), ("UBIO", "NASB"): (3336, 72), ("UBIO", "RST"): (892, 11),
}
